...
const COOKED_VEGS = [
  ...
  { value: 'roasted_eggplant',     label: 'Roasted Eggplant',         img: 'https://images.unsplash.com/photo-1587132137056-bfbf0166836e?w=300&q=80' },
...
const RAW_VEGS = [
  { value: 'bell_pepper',     label: 'Bell Pepper Strips',  img: BASE + 'bd8551348_generated_image.png' },
  { value: 'baby_carrots',    label: 'Baby Carrots',        img: BASE + '560498206_generated_image.png' },
  { value: 'cherry_tomatoes', label: 'Cherry Tomatoes',     img: 'https://images.unsplash.com/photo-1546094096-0df4bcaaa337?w=300&q=80' },
  { value: 'cucumber',        label: 'Cucumber Slices',     img: BASE + '14413b069_generated_image.png' },
  { value: 'celery',          label: 'Celery Sticks',       img: BASE + '1544e4aad_generated_image.png' },
  { value: 'snap_peas',       label: 'Snap Peas',           img: BASE + '7393b7c8b_generated_image.png' },
];
...
const FRUITS = [
  ...
  { value: 'blackberries', label: 'Blackberries', img: BASE + '230c67229_generated_image.png' },
  { value: 'raspberries',  label: 'Raspberries',  img: BASE + '98f59f2d6_generated_image.png' },
  ...
  { value: 'mandarin',     label: 'Mandarin',     img: BASE + '1a6bd348f_generated_image.png' },
  ...
  { value: 'cantaloupe',   label: 'Cantaloupe',   img: BASE + 'c90262de5_generated_image.png' },
  { value: 'honeydew',     label: 'Honeydew',     img: BASE + 'edd60a1af_generated_image.png' },
  ...
  { value: 'plum',         label: 'Plum',         img: BASE + 'd945e0102_generated_image.png' },
  { value: 'apricot',      label: 'Apricot',      img: BASE + '75702dc4a_generated_image.png' },
  ...
  { value: 'passion_fruit',label: 'Passion Fruit',img: BASE + '510dbff5f_generated_image.png' },
  { value: 'guava',        label: 'Guava',        img: BASE + 'b52f3a35c_generated_image.png' },
  { value: 'lychee',       label: 'Lychee',       img: BASE + 'ee277b276_generated_image.png' },
  { value: 'coconut',      label: 'Coconut',      img: BASE + 'a55123d8c_generated_image.png' },
  { value: 'fig',          label: 'Fig',          img: BASE + '33c058810_generated_image.png' },
